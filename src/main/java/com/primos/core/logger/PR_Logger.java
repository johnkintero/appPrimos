 ...
 * |---------|--------------|----------------|---------------------------------------------------------------------------------------------------------|
 * |   1.0   |  14/10/2018  |      GAOQ      | Creacion de la clase central que controla el log de la aplicacion.                                      |
 * |---------|--------------|----------------|---------------------------------------------------------------------------------------------------------|
 */
...
public class PR_Logger extends Logger {
     ...
     * </ol>
     */
    public static void PR_setLevel(Level level){
     ...
     * @return PR_Logger the logger for class.
     */
    public static PR_Logger getLogger(Class name) {
        return (PR_Logger) MY_FACTORY.makeNewLoggerInstance(name.getCanonicalName());
    }
